              ...
              <div className={heroStyles.demoCard}>
                ...
                <div className={heroStyles.itemsContainer}>
                  {[
                    ...
                    { description: "Consultation (2 hours)", amount: "RM3,000" },
                    { description: "Premium Hosting Setup", amount: "RM2,500" },
                  ].map((item, index) => (
                ...
                <div className={heroStyles.calculationContainer}>
                  <div className={heroStyles.calculationRow}>
                    ...
                    <span className={heroStyles.calculationValue}>RM20,500</span>
                  </div>
                  <div className={heroStyles.calculationRow}>
                    <span className={heroStyles.calculationLabel}>
                      GST (10%)
                    </span>
                    <span className={heroStyles.calculationValue}>RM2,050</span>
                  </div>
                  <div className={heroStyles.totalRow}>
                    <span className={heroStyles.totalLabel}>Total Amount</span>
                    <span className={heroStyles.totalValue}>RM22,550</span>
                  </div>
                </div>
